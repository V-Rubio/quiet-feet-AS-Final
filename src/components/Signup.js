            ...
            try{
                ...
                .then(res=>{
                    if(res.data==="exist"){
                        ...
                        history("/home",{state:{firstName:firstName, email: email}})
                    }
                })
                .catch(e=>{
                    alert("wrong details")
    ...
    return (
        ...
        <div className="login">
            ...
            <div className='item' id='logo'>
                <div className='textLogo'> 
                    ...
                    <div> 
                        ...
                        <Link to="/" id='qfLogo'>Quiet Feet</Link>
                    </div>
                    ...
                    <div> 
                    <label>Create an Account here to manage and protect your digital identity.</label>
                    </div>
                    </div>
                </div> 
            ...
            <div className='largeMarginTop largeMarginLeft'> 
                ...
                <input type="name" onChange={(e) => { setFirstName(e.target.value) }} placeholder="First Name"  />
                ...
                <input type="password" id="passwordRetype" onChange={(e) => { setPasswordAgain(e.target.value) }} placeholder="Re-Type Password" />
                <div><input type='checkbox' onChange = {(e) => {showPassword()}}/> Show Password</div>
                <Button type="submit" className='smallMarginTop' onClick={Submit} variant="dark">Submit</Button>
            ...
            <div className='blackLinkSmall'><Link to="/login" className='blackLink'>Login Page</Link></div>
